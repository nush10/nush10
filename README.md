...
🔹 Design clean, scalable data models (star schema, SCD2) that power analytics and BI

🔹 Debug data issues at scale — I’ve reduced data sync failures by 60% and cut query runtimes by 45%

🔹 Translate large datasets (2TB+) into clear, executive-ready dashboards (Power BI, Tableau, Looker)
